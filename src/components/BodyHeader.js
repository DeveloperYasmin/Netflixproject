...
const BodyHeader = () => {
  ...
  return (
    <div>
    <div id="dropdownbtn" className='w-full items-center justify-between flex bg-black bg-opacity-5'>
    ...
    <button className='pl-3 mr-20' onClick={toggledropdown}>
       ...
       {!isclick && <div className='absolute font-semibold rounded-lg ml-[1120px] p-3 w-44 m-2  text-white bg-gray-800 bg-opacity-70'>
            
       <img className=" absolute w-10 h-10 ml-[1000px] rounded-md" src={user?.photoURL}/>
